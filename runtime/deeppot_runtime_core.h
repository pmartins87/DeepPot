...
struct Card {
  int rank;  // 2..14
  int suit;  // 0..3, matching DeepPot c,d,h,s ordering after adapter conversion
};
...
struct QueryResult {
  ...
  int global_scenario_code;  // absolute code 1..494
  int flop_index;
...
class Strategy {
 public:
  ...
  // package_root contains:
  //   deeppot_runtime_index.bin
  //   strategy/N2_final.bits ... strategy/N8_final.bits
